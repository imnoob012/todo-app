...
INSERT INTO todos 
(title, priority, due_date, classification, description, created_by, updated_by, deleted_at, deleted_by, deleted_flg)
VALUES
('要件定義書の作成', 1, CURRENT_DATE + 5, 'DOCS', '新規プロジェクトの要件定義を完了させる', 'taro_yamada', 'taro_yamada', NULL, NULL, FALSE),
('ログイン機能の実装', 2, CURRENT_DATE + 10, 'FEATURE', 'Spring Securityを使用した認証機能の実装', 'taro_yamada', 'taro_yamada', NULL, NULL, FALSE),
('トップ画面のモック作成', 2, CURRENT_DATE + 7, 'OTHER', 'Figmaを使用してデザイン案を2パターン作成する', 'hanako_sato', 'hanako_sato', NULL, NULL, FALSE),
('備品購入', 3, CURRENT_DATE + 30, 'OTHER', 'ディスプレイ用のケーブルを購入する', 'admin_user', 'admin_user', NULL, NULL, FALSE),
('テストタスク', 2, CURRENT_DATE, 'TEST', 'テスト作成', 'taro_yamada', 'taro_yamada', CURRENT_TIMESTAMP, 'taro_yamada', TRUE);
